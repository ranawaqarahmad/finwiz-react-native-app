...
const NewCategory = () => {
  ...
  const addCategory = async () => {
    ...
    try {
      await fetch(`https://api-finwiz.softsquare.io/api/user/user-categories/${id}`, {
        method: 'PUT',
        headers: {
         ...
         <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 32 }}>
           ...
           <TouchableOpacity
             ...
             <View
               ...
               {editCategory ?
                 <Text style={{ color: category ? '#000000' : '#00000050', flex: 1 }}>{items ? items.category_name : 'Choose Category'}</Text>
