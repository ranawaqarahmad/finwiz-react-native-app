...
import { View, Text, StyleSheet, SafeAreaView, Image, TextInput, ScrollView, TouchableOpacity, Modal, ActivityIndicator } from 'react-native';
...
const Merge = () => {
  ...
  const mergeCategory = async () => {
    ...
    try {
      await fetch(`https://api-finwiz.softsquare.io/api/user/merge-user-categories`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${authToken}`,
          'Content-Type': 'application/json',
        ...
        <ScrollView
          ...
          <View style={styles.mainview}>
            ...
            <View
              ...
              <Text onPress={() => navigation.goBack()} style={{ fontSize: 16, fontWeight: '600', color: '#5145CD', alignSelf: 'center' }}>
                Cancel
              </Text>
            </View>

            <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 16, flex: 1 }}>
              ...
              <View style={{
                ...
                <Text style={{ fontSize: 14, fontWeight: '600', color: 'black', marginBottom: 15 }}>
              ...
              <View
                ...
                <Text style={{ fontSize: 14, fontWeight: '600', color: 'black', alignSelf: 'center', }}>Set Spending Limit</Text>
              ...
              <View style={{ marginHorizontal: 16, marginTop: 16 }}>
                <TouchableOpacity style={{ backgroundColor: '#7C56FE', borderRadius: 8, paddingVertical: 16, alignItems: 'center' }} onPress={mergeCategory}>
                  <Text style={{ fontSize: 16, fontWeight: '600', color: 'white' }}>{'Merge'}</Text>
                </TouchableOpacity>
              </View>
