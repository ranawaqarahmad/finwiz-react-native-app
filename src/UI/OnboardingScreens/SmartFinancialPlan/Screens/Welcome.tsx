        ...
        {loader ? (
          ...
          <View
            ...
            <View>
              ...
              {isErrorVisible && (
                <Text style={{color: 'red', fontWeight: '400', marginTop: 8}}>
                  {errorText}
                </Text>
              )}
              ...
              <View style={{marginTop: 25}}>
                ...
                <Text
                  ...
                  Password must be a minimum of 8 characters, include one letter
            ...
            <View style={{marginBottom: 16}}>
              <View>
                <Text
                  style={{fontSize: 14, fontWeight: '400', color: '#6B7280'}}>
                  By Continuing you agree to Finwiz platform{' '}
                  <Text style={{color: '#1C64F2'}}>
                    {' '}
                    terms and conditions, Rewards Policy
                  </Text>{' '}
                  and <Text style={{color: '#1C64F2'}}> Privacy Policy</Text>
                </Text>
              </View>
