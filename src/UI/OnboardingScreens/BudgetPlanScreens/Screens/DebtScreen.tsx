...
const DebtScreen = () => {
  ...
  const handleClickArrow = () => {
    navigation.navigate('BudgetingScreenA');
  };
  ...
  return (
    <View style={styles.mainview}>
      <Progress.Bar progress={0.27272727} width={null} color="#9747FF" />
      {/* cross image design */}
      <View style={styles.submain}>
        ...
        <View style={{ paddingBottom: 30 }}>
          ...
          How comfortable do you feel about handling debts and repayment? 
          </Text>
        ...
        <View>
          ...
          {['very Comfortable', 'Comfortable', 'Neutral', 'Uncomfortable','Very Uncomfortable'].map((option, index) => (
            <TouchableOpacity
              key={index}
              style={{
                padding: 10,
