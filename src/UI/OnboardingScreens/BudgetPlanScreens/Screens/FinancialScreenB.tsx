...
const FinancialScreenB = () => {
  ...
  return (
    <View style={styles.mainview}>
      <Progress.Bar progress={1} width={null} color="#9747FF" />
      {/* cross image design */}
      <View style={styles.submain}>
        ...
        <View style={{ paddingBottom: 30 }}>
          ...
          What type of budget, you would like to set
          </Text>
        ...
        <View>
          ...
          {['Monthly', 'Weekly', 'Bi Weekly'].map((option, index) => (
            <TouchableOpacity
              key={index}
              style={{
                padding: 10,
...
export default FinancialScreenB
