...
const BudgetingScreenB = () => {
  ...
  return (
    <View style={styles.mainview}>
      <Progress.Bar progress={0.46464646} width={null} color="#9747FF" />
      {/* cross image design */}
      <View style={styles.submain}>
        ...
        <View style={{ paddingBottom: 30 }}>
          ...
          When it comes to budgeting, what do you prefer? 
        ...
        <View>
          ...
          {['Strict', 'Balanced', 'Flexible'].map((option, index) => (
            <TouchableOpacity
              key={index}
              style={{
                padding: 10,
...
export default BudgetingScreenB;
