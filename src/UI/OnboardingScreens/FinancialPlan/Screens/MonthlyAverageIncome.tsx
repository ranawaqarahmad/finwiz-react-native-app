                ...
                <View style={{ width: '100%', height: '100%', paddingHorizontal: 16, backgroundColor: 'white', justifyContent: 'space-between' }}>
                    <View>
                        ...
                        <View style={{ marginTop: 29 }}>
                            {labeledArray.map((item, index) => <SelectionComponent key={index} onpress={selectType} index={index} title={item.title} selected={item.selected} />)}
                        </View>
                    ...
                    <View style={{ marginBottom: 16 }}>
                        ...
                        <View style={{ marginBottom: 16 }}>
                            ...
                            <RoundButtonComp onpress={() => { nextQuestion() }} />
