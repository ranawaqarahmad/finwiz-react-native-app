...
const ScrollViewDropDown = ({ open, setOpen, setItems, setValue, value, items, modalTitle, onDropDownChange }) => {
    return (
        ...
        >
            <DropDownPicker
                ...
                dropDownContainerStyle={{ borderWidth: 0, borderRadius: 24,  elevation: 10 }}
                style={{
                    borderRadius: 16,
                    flexDirection: 'row',
