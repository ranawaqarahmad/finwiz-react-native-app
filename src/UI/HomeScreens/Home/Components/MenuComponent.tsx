...
const MenuComponent = ({menuItem,onDelete,onMerge,onEdit,lockCategory}) => {
    ...
    return (
        <View style={{flex:1,}}>
            ...
            <View style={{ marginHorizontal:24, flex: 1,rowGap:12,}}>
                ...
                <TouchableOpacity onPress={()=>lockCategory(menuItem)} style={{ flexDirection: 'row', alignItems: 'center', columnGap: 16, }}>
                    <Image style={{ width: 24, height: 24 }} source={require('../../../../assets/Images/lockblack.png')} />
