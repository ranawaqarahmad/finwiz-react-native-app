...
const HomeScreen = () => {
  ...
  const lockCategory = async items => {
    ...
    try {
      await fetch(
        `https://api-finwiz.softsquare.io/api/user/user-categories/${items.id}`,
        {
          method: 'PUT',
          headers: {
            Authorization: `Bearer ${authToken}`,
  ...
  const getCategories = async type => {
    setCategoryLoader(true);
    fetch(
      `https://api-finwiz.softsquare.io/api/user/user-all-categories/${type}`,
      {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${authToken}`,
      ...
      .then(data => {
        ...
        // console.log(
        //   'Future 1st Month IS THIS',
        //   data?.data.futureMonth[0][0]?.month,
        // );
        // console.log(
        //   'Future 2nd MONTH IS THIS',
        //   JSON.stringify(data?.data.futureMonth),
        // );
      ...
      .then(data => {
        ...
        data.data[0].auth.map((item, index) => {
          ...
          if (item.balances_available) {
            unassignedcash =
              unassignedcash + convertStringToNumber(item.balances_available);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View
        ...
        <View
          ...
          <Text
            ...
            style={{marginEnd: 16, fontWeight: 'bold', color: 'red'}}>
            logout
          </Text>
          {/* BELLICON STARTS */}
          <TouchableOpacity
      ...
      <ScrollView
        ...
        <View style={{height: 150, marginHorizontal: 16, marginTop: 24}}>
          <ImageBackground
            source={require('../../../../assets/Images/balanceview.png')}
            resizeMode="stretch"
            ...
            <View
              ...
              <View style={{flex: 1, height: 75, justifyContent: 'center'}}>
                ...
                <Text
                  style={{fontSize: 12, fontWeight: '500', color: '#ffffff80'}}>
                  Total Balance
                </Text>
              </View>
        ...
        <View
          ...
          <View style={{justifyContent: 'center'}}>
            <TouchableOpacity
              onPress={() => {
                navigation.navigate('EditAllCategories', {budgets: budgets});
              }}>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <View
              style={{
                backgroundColor: type == null ? '#1F2A37' : '#E5E7EB',
                borderRadius: 15,
                height: 29,
                justifyContent: 'center',
                paddingHorizontal: 16,
          ...
          <TouchableOpacity
            ...
            <View
              style={{
                backgroundColor: type == 0 ? '#1F2A37' : '#E5E7EB',
                borderRadius: 15,
                height: 29,
                justifyContent: 'center',
                alignItems: 'center',
          ...
          <TouchableOpacity
            ...
            <View
              style={{
                backgroundColor: type == 1 ? '#1F2A37' : '#E5E7EB',
                borderRadius: 15,
                height: 29,
                justifyContent: 'center',
                paddingHorizontal: 16,
        ...
        {budgets.length == 0 && categoryLoader === false && (
          <View
            ...
            />
            <Text style={{fontSize: 20, fontWeight: 'bold', color: '#347BFA'}}>
              The list is Empty
            </Text>
          </View>
        )}
