...
const SubCategoryDetails = () => {
  ...
  const getTransactions = async () => {
    ...
    fetch(
      `https://api-finwiz.softsquare.io/api/user/transaction-count-with-detail/${basicDetails.id}?page=${pageNumber}`,
      {
        method: 'GET',
        headers: {
      ...
      .then(data => {
        ...
        console.log(
          'NEXT PAGE URL',
          categories.transactionDetails.next_page_url,
        );
