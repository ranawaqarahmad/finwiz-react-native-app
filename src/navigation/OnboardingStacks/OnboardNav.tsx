    ...
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      <View style={{flex: 1, backgroundColor: 'white'}}>
        ...
        <Stack.Navigator
          ...
          <Stack.Screen
            name="SmartFinancialPlan"
            component={SmartFinancialPlan}
          />
          <Stack.Screen
            name="SmartFinancialPlanScreen"
            component={SmartFinancialPlanScreen}
          />
          <Stack.Screen
            name="FinancialParentScreen"
            component={FinancialParentScreen}
          />
